...
public class BinaryHeap<E extends Comparable<E>> {
    ...
    private final HashMap<E, Integer> memoire;
	...
	this.memoire = new HashMap<>(heap.memoire);
    }
    ...
    /**
     * Update the element x in the heap
     * @param x the item to update
     */
    public void update(E x) {
 
        Integer index = memoire.get(x);
        percolateUp(index);
        percolateDown(index);
    }
